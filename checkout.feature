            ...
            Dado que o cliente preencha com dados inválidos
            Quando o cliente preencher o campo de <email>
            E esse formato de email for inválido ou o cliente deixar um <campo de dados vazio>
